...
public class DataSource implements DataBaseService {
    ...
    public boolean removeTaskById(long id) {
        open();
        int affected = database.delete(DataOpenHelper.TABLE_Task, DataOpenHelper.COLUMN_ID + " = " + id, null);
        return affected > 0;
    }

    public ArrayList<Task> findAllTasks() {
        open();
        String[] columns = {DataOpenHelper.COLUMN_ID, DataOpenHelper.COLUMN_TITLE, DataOpenHelper.COLUMN_DATE, DataOpenHelper.COLUMN_DESCRIPTION
        ...
        Cursor cursor = database.query(DataOpenHelper.TABLE_Task, columns, null, null, null, null, null);
    ...
    private ArrayList<Task> cursorToArrayList(Cursor cursor) {
        ...
        while (cursor.moveToNext()) {
            ...
            task.setId(cursor.getLong(cursor.getColumnIndex(DataOpenHelper.COLUMN_ID)));
